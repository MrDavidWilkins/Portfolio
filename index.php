...
<html>
  ...
  <body>
    <!-- <div class="lightbox hidden">
      <div class="topBar">
        <div class="close">
          <i class="fa fa-times fa-inverted fa-lg"></i>
        </div>
      </div>
      <div class="twoPanel">
        <div class="panel leftPanel">
          <img class="panelImage" src="assets/img/sound.jpg" alt="">
          <img class="panelImage" src="assets/img/doyousee.jpg" alt="">
          <img class="panelImage" src="assets/img/stanley.jpg" alt="">
          <img class="panelImage" src="assets/img/pineville.jpg" alt="">
          <img class="panelImage" src="assets/img/fullout.jpg" alt="">
          <img class="panelImage" src="assets/img/prisonerx.jpg" alt="">
          <img class="panelImage" src="assets/img/.jpg" alt="">
        </div>
    ...
    <div class="lightbox hidden">
      ...
      <section class="twoPanel">
        <form action="index.php" method="post">
          <label class="label name"for="name" >NAME </label><input class="textbox name"name="name" type="text" maxlength="30" /><br>
          <label class="label email"for="email">EMAIL </label><input  class="textbox email"name="email" type="text" maxlength="30" /><br>
          <label class="label street"for="street">STREET </label><input class="textbox street"name="street" type="text" maxlength="30"/><br>
          <label class="label message"for="message">MESSAGE </label><textarea rows="8" class="textbox message msgBox" name="message"></textarea><br>
    ...
    <div class="container" id="parent">
      <div class="topButton">
        ...
        <button class="mainButton rightButton" id="motion" type="button" name="button">
      ...
      <div class="botButton">
        <button class="mainButton leftButton" id="development" type="button" name="button"></button>
        <button class="mainButton rightButton" id="hideHUD" type="button" name="button"></button>
      </div>
    </div>
